...
!["Правильный" тайм-менеджмент - работать со вторым квадрантом](/assets/images/lqCt4ZaM.png)
...
![Настройки по умолчанию для алгоритма расчёта приоритета](/assets/images/2nS-kCGL.png)
...
![Параметры задачи Amplenote](/assets/images/A5ahRGBg.png)
...
![Вес задачи в Amplenote](/assets/images/EGge_DuQ.png)
